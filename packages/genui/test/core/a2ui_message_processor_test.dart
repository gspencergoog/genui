...
void main() {
  group('$A2uiMessageProcessor', () {
    ...
    test('handleMessage adds a new surface and fires SurfaceAdded', () async {
      const surfaceId = 's1';
      ...
      expect(definition.rootComponentId, 'root'); // Default root id is 'root'
    ...
    test('handleMessage removes a surface and fires SurfaceRemoved', () async {
      ...
      final Future<GenUiUpdate> futureUpdate = messageProcessor.surfaceUpdates
          .where((e) => e is SurfaceRemoved)
          .first;
