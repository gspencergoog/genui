...
/// generate content (v0.8 implementation).
class GoogleGenerativeAiContentGeneratorV08
    implements GoogleGenerativeAiContentGenerator {
  /// Creates a [GoogleGenerativeAiContentGeneratorV08] instance with specified
  /// configurations.
  GoogleGenerativeAiContentGeneratorV08({
  ...
  Future<Object?> _generate({
    ...
    try {
      final availableTools = [
        ...
        DeleteSurfaceTool(
          handleMessage: _a2uiMessageController.add,
          messageFactory: (surfaceId) => DeleteSurface(surfaceId: surfaceId),
        ),
        ...additionalTools,
      ];
