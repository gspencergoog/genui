...
import 'package:genui_firebase_ai/src/firebase_ai_content_generator_v0_9.dart';
import 'package:genui_firebase_ai/src/gemini_generative_model.dart';
import 'package:json_schema_builder/json_schema_builder.dart' as dsb;

void main() {
  group('FirebaseAiContentGeneratorV09', () {
    const genui.A2uiProtocolVersion version = genui.A2uiProtocolVersion.v0_9;
    ...
    test('isProcessing is true during request', () async {
      ...
      expect(generator, isA<FirebaseAiContentGeneratorV09>());
