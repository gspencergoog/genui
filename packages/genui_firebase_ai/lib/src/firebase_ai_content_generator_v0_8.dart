...
import 'firebase_ai_content_generator.dart';
...
class FirebaseAiContentGeneratorV08 implements FirebaseAiContentGenerator {
  /// Creates a [FirebaseAiContentGeneratorV08] instance with specified
  /// configurations.
  FirebaseAiContentGeneratorV08({
  ...
  @override
  final A2uiProtocolVersion protocolVersion = A2uiProtocolVersion.v0_8;

  // ignore: unused_field
  final A2uiProtocol _protocol = A2uiProtocol.fromVersion(
  ...
  Future<void> _generate({required Iterable<ChatMessage> messages}) async {
    ...
    while (toolUsageCycle < maxToolUsageCycles) {
      ...
      genUiLogger.finest('System Instruction: $fullSystemInstruction');
